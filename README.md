# genpark-realtime-voice-interruption-turn-taking-manager-skill
...
> **GenPark AI Agent Skill** -- Real-time acoustic voice interruption and turn-taking manager with sub-150ms speech cutoff (Vapi style)
